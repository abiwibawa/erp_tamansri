...
class CI_Tree {
	...
	function writeCSS()
	{
		...
		*/		
		...
		#dhtmlgoodies_tree .tree_link a:active{
			color:blue;
		}
...
************************************************************************************************************/	
	...
	*/
	...
	function addToArray($id,$name,$parentID,$url="",$target="",$imageIcon="Green.png"){
	...
	function drawTree(){
		...
		for($no=0;$no<count($this->elementArray[0]);$no++){
			...
			echo "<li class=\"tree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"".$this->folderimage."dhtmlgoodies_plus.gif\"><img src=\"".$this->folderimage.$this->elementArray[0][$no][4]."\"><a href=\"#\" id=\"".$this->elementArray[0][$no][1]."\" class=\"tree_link ".$this->elementArray[0][$no][0]."\">".$this->elementArray[0][$no][1]."</a>";		
	...
	private function drawSubNode($parentID){
		if(isset($this->elementArray[$parentID])){			
			...
			for($no=0;$no<count($this->elementArray[$parentID]);$no++){
				...
				echo "<li class=\"tree_node\"><img class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"".$this->folderimage."dhtmlgoodies_plus.gif\"><img src=\"".$this->folderimage.$this->elementArray[$parentID][$no][4]."\"><a href=\"#\" id=\"".$this->elementArray[$parentID][$no][0].'-'.$this->elementArray[$parentID][$no][1]."\" class=\"tree_link ".$this->elementArray[$parentID][$no][0]."\">".$this->elementArray[$parentID][$no][1]."</a>";	
