<script>
	...
	$(document ).ready(function() {
		var id = $("#id_kwitansi").val();
		var vurl = "<?=base_url('penjualan_kwitansi/get_item')?>";
		
		var parsing = {id_kwitansi:id};
		//console.log(parsing);
		$.ajax({
				type: "POST",
				dataType: "json",
...
<div class="row">             
	...
	<input type="hidden" name="id_kwitansi" id="id_kwitansi" value="<?=$this->form_data->id_kwitansi?>">
	<input type="hidden" name="id_temp" id="id_temp" value="<?=$this->form_data->no_kwitansi?>">
	<div class="col-md-9">
		<div class="block block-fill-white">
			...
			<div class="content controls">
				<div class="form-row">
					...
					<div class="col-md-4"><?=form_input('no_surat',$this->form_data->no_kwitansi,'class="form-control" readonly')?></div>
				</div>
				
				<div class="form-row">
					<div class="col-md-2">Kode Customer</div>
					<div class="col-md-3"><?=form_input('kode_customer',$this->form_data->kode_customer,' class="form-control" id="kode_customer" readonly ')?></div>
				...
				<div class="form-row">
					...
					<div class="col-md-3"><?=form_input('ttd',$this->form_data->nama_ttd,'class="form-control" id="ttd" readonly')?></div>
					<input type="hidden" name="id_ttd" value="<?=$this->form_data->id_ttd?>" id="id_ttd">
