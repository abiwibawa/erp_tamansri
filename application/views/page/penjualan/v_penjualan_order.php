		...
		<div class="block block-fill-white">
			...
			<div class="content controls">
				<div class="form-row">
					...
					<div class="col-md-3"><?=form_input('no_dokumen','',' class="form-control" id="no_dokumen" onClick="popupcaritempdokumen()" ')?></div>
					<div class="col-md-1"><button type="button" class="btn btn-success" onclick="tampil()">tampil</button></div>
				...
				<div class="form-row">
					...
					<div class="col-md-4"><textarea name="keterangan_order" id="keterangan_order" class="form-control"></textarea></div>
				</div>
			</div>
		</div>
	</div>
