...
Class master_customers extends CI_Controller{
	...
	function addmodal(){
		...
		$this->load->view('page/master/modal/mod_master_customers',$data);
	}
	...
	function editmodal(){
		...
		$select = array('id_customer','kode_customer','nama','kode_barang','inisial','alamat','kota','kodepos','telpon','email','npwp');
