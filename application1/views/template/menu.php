						...
						<ul class="dropdown-menu">
							<li>
								...
								<ul class="dropdown-submenu">
									<li><a href="<?=base_url('penjualan_order')?>">Buat Order</a></li>
									<li><a href="<?=base_url('penjualan_laporder')?>">Lap. Order</a></li>
								</ul>
							</li>
							<li>
								...
								<ul class="dropdown-submenu">
									...
									<li><a href="<?=base_url('penjualan_lapsj')?>">Lap. Surat Jalan</a></li>
								</ul>
							</li>
							<li>
								...
								<ul class="dropdown-submenu">
									...
									<li><a href="<?=base_url('penjualan_lapinvoice')?>">Lap. Invoice</a></li>
								</ul>
							</li>
							<li>
								<a href="#">Reture <i class="icon-angle-right pull-right"></i></a>
								<ul class="dropdown-submenu">
									<li><a href="<?=base_url('penjualan_reture')?>">Buat Reture</a></li>
									<li><a href="<?=base_url('penjualan_lapreture')?>">Lap. Reture</a></li>
								</ul>
							</li>
							<li>
								...
								<ul class="dropdown-submenu">
									...
									<li><a href="<?=base_url('penjualan_lapfp')?>">Lap. Faktur Pajak</a></li>
								</ul>
							</li>
							<li>
